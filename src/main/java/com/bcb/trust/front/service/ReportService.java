...
public class ReportService {
    ...
    public void generateReport() throws ParseException {
        ...
        try {
            ...
            if (!workerList.isEmpty()) {
                ...
                maxYearsRightsAcquired = (Integer) namedParameterJdbcTemplate.getJdbcTemplate().queryForObject(sql,
                        Integer.class);
    ...
    private Map<String, Object> getParameters(WorkerDetail workerDetail) throws ParseException {
        ...
        rangeYearsWorked = (String) namedParameterJdbcTemplate.queryForObject(sql,
        ...
        if (yearsWorked >= maxYearsRightsAcquired) {
            ...
            percentageRightsAcquired = (Double) namedParameterJdbcTemplate.queryForObject(sql,
        ...
        grandTotalPreviousBalance = (Double) namedParameterJdbcTemplate.queryForObject(sql, sqlParameterSource,
                Double.class);
    ...
    private List<IndividualReportAcount> getData(WorkerDetail workerDetail, Double previousBalance)
        ...
        for (IndividualReportAcount individualReportAcount2 : namedParameterJdbcTemplate.query(sql, parameterSource,
