...
public class BusinessConsultantFrontController {
    ...
    @GetMapping("/business-consultant-front")
    public String index(Model model) {

        List<CatalogUserEntity> businessConsultantList = new ArrayList<>();
        ...
        try {
            ...
            for (ConfigurationUserProfileEntity configurationUserProfileEntity : configurationUserProfiles) {
                if (configurationUserProfileEntity.getActive() == 1) {
                    businessConsultantList.add(configurationUserProfileEntity.getUserEntity());
                }
            }
        } catch (Exception e) {
        ...
        model.addAttribute("businessConsultantList", businessConsultantList);
        return "request/catalog/business-consultant/index";
    }
